...
const state = { pitches: [], active: new Map(), context: null, focus: null };
...
async function generate() {
  ...
  try {
    ...
    state.pitches = data.pitches; state.focus = null; el("scale-name").textContent = `${name} · ${data.count} intervals`; render(); setStatus(`${data.count} intervals`, "");
